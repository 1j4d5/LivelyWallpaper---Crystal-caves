...
function livelyPropertyListener(name, val)
{
  switch(name) {  
    case "spotlightRadius":
      settings.spotlightRadius = val;
      console.log(settings.spotlightRadius);
      break;   
    case "boxCount":
      settings.boxCount = val;
      console.log(settings.boxCount);
    break;    
    case "moveSpeed":
      settings.moveSpeed = val/100;
      console.log(settings.boxCount);
    break;   
    case "turboSpeed":
      settings.turboSpeed = val;
      console.log(settings.boxCount);
    break;   
  }
}
